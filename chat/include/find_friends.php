...
<?php
session_start();
include("../functions/findFriends.php");
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <a class="navbar-brand" href="#">
    <?php
      ...
      echo"<a class='navbar-brand' href='../pages/home.php?user_name=$user_name'>MyChat</a>";
    ?>
  </a>
  <!-- Links -->
  <ul class="navbar-nav">
    <li><a style="color: white; text-decoration: none;font-size: 20px;" href="../pages/account_settings.php">Settings</a></li>
  </ul>
</nav><br>
<div class="row">
    <div class="col-sm-4">
